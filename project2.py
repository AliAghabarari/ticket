...
class Customer_data:
    ...
    def create_table(self):
        ...
        self.cur.execute(
            "CREATE TABLE IF NOT EXISTS Customer(Name TEXT PRIMARY KEY, Email TEXT, Ceremony_name TEXT, Time TEXT, Date TEXT)"
        )
        self.con.commit()
    ...
    def insert_customer(self, name: str, email: str, ceremony_name: str, ceremony_time: str, ceremony_date: str):
        ...
        self.cur.execute(
            ...
            (name, email, ceremony_name, ceremony_time, ceremony_date),
        )
        self.con.commit()
...
def create_ceremony():
    ...
    global d, selected_time, st, t, x, n, dest
    ...
    def cont():
        ...
        global t, x, n, dest, d, st
        n = ceremony_name_entry.get()
            ...
            if bool(select) == False:
                ...
                if bool(cn) == False or bool(ce) == False :
                    ...
                    if bool(result) == False:
                        ...
                        customer = Customer_data(path)
                        customer.insert_customer(cn, ce, select, cdata[4], cdata[2])
                        cust = customer.select_person(cn)
                        print(cust)
                    ...
                    # THAT FOR SENDING GMAIL
                            ...
                            customer_name = cn
                            customer_email = ce
                            customer_ceremony = select
                            ceremony_time = cdata[4]
                            ceremony_date = cdata[2]
